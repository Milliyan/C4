  ...
  return (
    <div className="h-16 bg-white border-b border-slate-200 px-6 flex items-center justify-between shadow-sm z-20">
      ...
      <div className="flex items-center gap-4">
        ...
        <button
          onClick={onAnalyze}
          className="h-10 px-6 bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white rounded-lg font-semibold text-sm flex items-center gap-2 transition-colors shadow-sm shadow-blue-200"
        >
