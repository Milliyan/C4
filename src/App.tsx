...
const AppContent = () => {
  ...
  const onEdgeDoubleClick = useCallback((event: React.MouseEvent, edge: Edge) => {
    ...
    // 3. Create New Edges
    // We create two new edges to replace the split one.
    // We use arbitrary handles (left/right) for the junction to ensure connectivity.
    // Since connectionMode is Loose, this is valid.
